...
<body> 
<form action="${pageContext.request.contextPath}/medicine?method=update" 
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <img  width="80px" height="50px" src="${medicine.picture }">
        </td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">进价</td>
        <td><input type="text" name="inPrice" value="${medicine.inPrice }"/>元</td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">售价</td>
        <td><input type="text" name="salPrice" value="${medicine.salPrice }" />元</td>
    </tr>
    <tr>
