...
<body>
<form action="${pageContext.request.contextPath }/register" method="post" class="definewidth m20">
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td>
        	...
        	<input type="radio" name="isPay" value="1" <c:if test="${register.ispay == false }"> checked='checked'</c:if>/>否&nbsp;&nbsp;&nbsp;
            <input type="radio" name="isPay" value="0" <c:if test="${register.ispay == true }"> checked='checked'</c:if>/>是</td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">性别</td>
        <td><input type="radio" name="sex" value="0" <c:if test="${register.sex == false }"> checked='checked'</c:if>/>男&nbsp;&nbsp;&nbsp;
            <input type="radio" name="sex" value="1" <c:if test="${register.sex == true }"> checked='checked'</c:if>/>女</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
        	<input type="radio" name="consultation" value="0" <c:if test="${register.consultation == false }"> checked='checked'</c:if>/>初诊&nbsp;&nbsp;&nbsp;
            <input type="radio" name="consultation" value="1" <c:if test="${register.consultation == true }"> checked='checked'</c:if>/>复诊
         </td>
    </tr>
    <tr>
